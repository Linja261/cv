...
## 1. HR-Recruiter (6-Sekunden-Scan)

**Was sofort auffällt (positiv):**
- Klares visuelles Layout, professionell, nicht überladen
- Hero Statement liefert sofort Kontext: 13+ Jahre, Produkt, Business, Transformation
- "Ich suche strategische Gestaltungsverantwortung" – Suchintention klar, spart dem Recruiter Ratearbeit
- Metriken bei ABS springen ins Auge: 3,5 Mio. €, +132 %, +178 %
- ista-Klammer ("4 Rollen in 8 Jahren") entschärft die "nur 2 AG"-Frage proaktiv

**Was im Scan untergeht oder irritiert:**
- Tagline "Strategische Übersetzerin, Systemarchitektin, Kulturgestalterin" – klingt anspruchsvoll, aber keiner dieser Begriffe ist ein Jobtitel. Ein Recruiter, der nach "Head of Product" oder "Chief of Staff" filtert, findet hier keinen Anker
- Kein Familienstand, kein Geburtsdatum sichtbar – korrekt und zeitgemäß
- Keine Branche/Industrie im Hero-Text genannt – "Energiedienstleister" und "Absturzsicherung" stehen erst tief in den Stationen. Recruiter mit Branchenfilter könnten abspringen
- Zertifizierungen sind da, aber Product Discovery (Pendo) und Metrics for PM (Mind the Product) sind eher Nischen – kein PMP, kein PSPO, keine bekannten Marken

**Risiko-Einschätzung:**
- Bei ATS-Systemen (Applicant Tracking): Die Tagline und der Hero-Text enthalten wenig standard-keywordsuchbare Begriffe. "Product Management", "Digital Product", "Agile" kommen vor, aber versteckt
- Empfehlung: Keywords in den Hero-Text oder als unsichtbare Meta-Begriffe einbauen

---

## 2. Hiring Manager / Fachliche Führungskraft

**Stärken:**
- Die Entwicklungslogik ist nachvollziehbar: Research → Innovation → IT/Change → Produkt. Das zeigt Lernfähigkeit und Vielseitigkeit
- ABS-Station hat harte Ergebnisse (Umsatz, Nutzerzahlen) – das ist die stärkste Station
- ista Specialist Marketing: Ausgründungen (Tooltime, Objego) sind ein echtes Highlight – zeigt unternehmerisches Denken
- Methodik-Sektion mit den 4 Quadranten zeigt Reflexionsfähigkeit
- "Laterale Führung" und "Crossfunktionales Team" signalisiert: kann ohne disziplinarische Macht bewegen

**Fragen, die ich im Gespräch stellen würde:**
- "Sie haben 5+ Jahre bei ABS Safety – was hat Sie so lange gehalten?" (Gegenstück zur ista-Mobilität)
- "Senior Specialist IT Support & Communication" klingt nach Helpdesk – der Inhalt ist aber strategisch. Warum dieser Titel?
- "Laterale Führung" – wie viele Leute, welche Disziplinen?
- "Hypothesengetriebene Produktentwicklung mit 30+ Interviews" – wie sieht der Output aus? Wo sind die Entscheidungen, die daraus folgten?
- ista-Station 2 (IT Support): "Neustrukturierung des IT-Portfolio-Managements über 17 Länder mit signifikant erhöhter Umsetzungswahrscheinlichkeit" – was bedeutet "signifikant"? Zahlen fehlen

**Bedenken:**
- Kein einziges Produkt wird beim Namen genannt (außer Tooltime/Objego als Ausgründungen). Was hat sie bei ABS konkret gebaut? "Digitale Bestellstrecke" und "Dokumentations-Tool" sind generisch
- Keine Teamgröße bei ABS genannt – "crossfunktionales Produktteam" kann 3 oder 15 Leute sein
- M.Sc. Marketing & Communications + B.A. International Management → solide, aber kein Tech-Background. Für Head of Product bei tech-lastigen Firmen könnte das eine Frage aufwerfen

---

## 3. Geschäftsführer / C-Level

**Was überzeugt:**
- "Direktes Reporting an CEO und CFO" bei ista – hat C-Level-Nähe bereits bewiesen
- 3,5 Mio. € Mehrumsatz – spricht die Sprache des Geschäfts
- EU-Direktive über 17 Märkte – das ist Komplexität auf Enterprise-Level
- Haltungs-Sektion ("Verstehen vor Handeln", "Klarheit vor Kontrolle") signalisiert Reife und Reflexion
- Der Wechsel Konzern → Mittelstand zeigt Pragmatismus und Hands-on-Mentalität

**Was ein GF vermissen würde:**
- **P&L-Verantwortung:** Nirgendwo erwähnt. Hat sie ein Budget verantwortet? Ein Kostenzentrum geführt? Für Head of Product oder CoS wäre das wichtig
- **Skalierung:** Die Zahlen bei ABS sind beeindruckend, aber es klingt nach einem Mittelständler. Wie ist die Übertragbarkeit auf größere Strukturen?
- **Team-Aufbau:** Hat sie Teams aufgebaut oder nur bestehende geführt? Für eine Führungsrolle macht das einen Unterschied
- **Strategischer Impact auf Unternehmensebene:** Bei ista ja (EU-Direktive, M&A), bei ABS weniger sichtbar – es klingt nach Produktebene

**Gesamturteil:**
Für eine CoS-Rolle: starkes Profil (Übersetzerin, Cross-funktional, C-Level-Erfahrung). Für Head of Product: solide, aber P&L und Teamgröße fehlen. Für Strategy/BizDev: die ista-Vergangenheit (Markt-Rollouts, M&A) ist stärker als die ABS-Gegenwart.

---

## 4. Headhunter / Executive Search

**Positionierung im Markt:**
- Stärke: Seltene Kombination aus Produktmanagement + Change/Transformation + Business Development. Die meisten PMs haben entweder den Tech-Track oder den Business-Track – Linja hat beides
- Schwäche: Die Positionierung ist sehr breit. "Strategische Systemgestalterin" ist kein Markt-Label. Headhunter brauchen eine klare Box, um Kandidat:innen vorzuschlagen

**Empfohlene Positionierung je Zielrolle:**
- **Head of Product / Group PM:** "Digital Product Lead mit 5+ Jahren E2E-Verantwortung und Background in Business Development und Change"
- **Chief of Staff:** "Strategische Generalistin mit C-Level-Erfahrung, Cross-funktionaler Steuerung und Change-Hintergrund"
- **Strategy / BizDev:** "Strategin mit internationalem Rollout-Track-Record und Erfahrung in M&A, Go-to-Market und Produktinnovation"

**Gehaltskorridor-Einschätzung (DE, 2026):**
- Head of Product (Mittelstand): 90–120k
- Head of Product (Scale-up/Konzern): 110–140k
- Chief of Staff: 100–130k
- Strategy Director: 100–140k

**Marktvorteil:** KI-Literacy explizit im CV, 13+ Jahre Erfahrung, Deutsch + Englisch, NRW-Standort (hybrid-freundlich)

---

## 5. Peer / Kolleg:in (Authentizitäts-Check)

**Was echt wirkt:**
- Die Haltungs-Sektion klingt nicht nach Textbaustein, sondern nach gelebter Überzeugung
- "Veränderungen mit Menschen gestalten & nicht nur Systeme umzubauen" – das ist ein Satz, den jemand sagt, der schlechte Change-Projekte erlebt hat
- Die Ausgründungen (Tooltime, Objego) sind verifizierbar – das ist ein starkes Vertrauenssignal
- Der Wechsel von ista zu ABS Safety als "bewusste Entscheidung" liest sich authentisch, nicht als Notlösung

**Was überzogen wirken könnte:**
- "Strategische Übersetzerin, Systemarchitektin, Kulturgestalterin" – drei große Wörter nebeneinander. Jedes für sich wäre stark, zusammen wirkt es etwas viel
- "Strategische Systemgestalterin" im Hero – doppelt mit der Tagline
- "90% Hardware-Marktanteil gesichert" – war das ihre Leistung allein? Die Formulierung suggeriert es

---

## 6. Zusammenfassung: Top-5-Stärken und Top-5-Handlungsfelder

### Stärken
1. Harte Metriken bei ABS (3,5 Mio. €, +132%, +178%) – selten bei Product-CVs
2. Breite: Research → Innovation → IT/Change → Produkt – echte T-Shape
3. ista-Klammer löst die "nur 2 AG"-Frage elegant
4. Haltungs-Sektion hebt sich ab – zeigt Reflexionstiefe
5. "Ich suche..."-Satz gibt Recruiter:innen klare Orientierung

### Handlungsfelder
1. **Teamgröße und P&L fehlen** – für Führungsrollen das größte Gap
2. **Tagline zu abstrakt** – "Systemarchitektin" ist kein suchbarer Begriff
3. **Produkte nicht beim Namen** – ABS-Produkte bleiben generisch
...
1. **Kurzfazit** Sehr starkes Senior-Profil mit klarer Wirkung, guter Zahlenbasis und hoher Differenzierung. Der größte Hebel liegt nicht in mehr Inhalt, sondern in besserer Übersetzung für Recruiter-Logik: klare Zielrollen, schnell scannbare Outcomes, eindeutige Chronologie. **Was bereits sehr gut ist**
    ...
    - Klare Differenzierung über „Strategische Übersetzerin / Systemarchitektin / Kulturgestalterin“.
    - Harte Ergebnisse sind vorhanden (z. B. +3,5 Mio. €, +132 % aktive Nutzer, 17 Ländermärkte).
    - Starke Schnittstellenkompetenz Business–Produkt–Tech–Organisation.
    - Führung ohne disziplinarische Macht ist gut erkennbar.
    - Profil wirkt reif, reflektiert und wirksam, nicht nur operativ.
    
    **Größte Hebel** Deine Identität ist stark. Jetzt muss sie zusätzlich recruiter-kompatibel verschlagwortet werden.
    
    - Titel- und Rollenfit schärfen (ATS + Recruiter-Search)
    
    Aktuelle Positionierung ist stark, aber zu „künstlerisch“ für Suchalgorithmen. Oben zusätzlich klassische Rollenbegriffe ergänzen: Senior Product Managerin | Product Lead | Transformation Lead | AI Workflow / Context Engineering. 
    
    **Positionierung auf Recruiting-Perspektive optimieren** 
    (Ich glaube, dass man das pro Position modulieren kann, wenn einem die Stelle wichtig ist. Vielleicht kann man es aber auch im Standard schon etwas kompatibler aus Recruiting-Sicht aufbauen) "Nicht nur wer du bist, sondern welchen Unternehmensnutzen du reproduzierbar erzeugst, muss oben in 15 Sekunden sichtbar sein."
    
    - Top-Bereich auf Outcomes umstellen
    
    Die Summary ist gut geschrieben, aber zu lang für 10-Sekunden-Scan. Ergänze direkt darunter 4–5 Outcome-Bullets mit Zahlen. 
    **Bsp.:** Senior Product Managerin | Product & Transformation Lead | AI-Enabled Workflow Design Ich verbinde Business, Produkt, Technologie und Organisation, um komplexe Vorhaben in messbare Ergebnisse zu übersetzen. Ausgewählte Outcomes:
    
    - +3,5 Mio. € Mehrumsatz durch digitale Bestellstrecke, gleichzeitig 50 % schnellere Bearbeitung
    - +132 % aktive Nutzer und +178 % Dokumentationsvolumen durch kundenorientiertes Produkt
    - Steuerung regulatorischer Umsetzung in 17 Ländermärkten mit 40+ Stakeholdern
    - Aufbau wirksamer Discovery- und Entscheidungsprozesse (30+ Interviews, systematische Validierung)
    
    — **AI/Context Engineering** ist bei dir kein Add-on, sondern ein Markt-Differentiator und sollte als eigener Kompetenzblock erscheinen.
    
    - z.B. eigenen Mini-Block aufnehmen mit 2–3 konkreten Use Cases und Wirkung (Geschwindigkeit, Qualität, Entscheidungszeit).
    
    **Methoden/Tools besser clustern** Die lange Liste ist inhaltlich stark, aber visuell schwer scannbar. In 4 Cluster gliedern: Product Strategy, Delivery, Leadership/Change, AI & Analytics.
    
2. — — Ansonsten bin ich aber vor allem bei der Ersteinschätzung: das ist ein richtig starkes CV. Das kann auch so jetzt schon raus. Die Punkte die ich jetzt benannt hab sind keine Blocker, sondern kannst du angehen, wenn du wirkliche "Traum"-Stellen addressierst. Und deshalb nochmal einen Tag investieren willst